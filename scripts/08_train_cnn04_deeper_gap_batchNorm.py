"""
08_train_cnn04_deeper_gap_batchNorm.py

CNN-04: Deeper GAP architecture with Batch Normalization.
"""
...
def build_cnn04_deeper_gap_batchnorm(
    input_shape: tuple[int, int, int],
    num_classes: int,
) -> keras.Model:
    """
    CNN-04: Deeper CNN with GlobalAveragePooling2D and Batch Normalization.
    ...
    return keras.Model(
        inputs=inputs,
        outputs=outputs,
        name="CNN_04_Deeper_GAP_BatchNorm",
    )
...
def main():
    ...
    run_experiment(
        model_name="CNN_04_Deeper_GAP_BatchNorm",
        build_model_fn=build_cnn04_deeper_gap_batchnorm,
        config=config,
        architecture_notes=(
            "Deeper architecture identical to CNN_03_Deeper_GAP but adds "
